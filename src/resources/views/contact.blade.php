        ...
        <table class="contact__form">
            <tr class="contact__form--tr">
                ...
                <td class="contact__form--right">
                    <input class="contact__form--name-left" type="text" name="last_name" value="{{ old('last_name') }}" placeholder="　　例：山田">
                    <input class="contact__form--name-right" type="text" name="first_name" value="{{ old('first_name') }}" placeholder="　　例：太郎">
                </td>
            </tr>
            <tr class="contact__form--tr">
            ...
            <tr class="contact__form--tr">
                ...
                <td class="contact__form--right"><input  class="contact__form--email" type="email" name="email" value="{{ old('email') }}" placeholder="　　例：test@example.com"></td>
            </tr>
            <tr class="contact__form--tr">
                <td class="contact__form--left"></td>
                <td class="contact__form--right">
            ...
            <tr class="contact__form--tr">
                ...
                <td  class="contact__form--right">
                    <input class="contact__form--tel" type="tel" name="tell" placeholder="080" size="3" maxlength="3" value="{{ old('tell') }}">
                    <p class="contact__form---" >-</p>
                    <input class="contact__form--tel"  type="tel" name="tell2" placeholder="1234" size="4" maxlength="4" value="{{ old('tell2') }}">
                    <p class="contact__form---" >-</p>
                    <input class="contact__form--tel"  type="tel" name="tell3" placeholder="5678" size="4" maxlength="4" value="{{ old('tell3') }}">
                </td>
            </tr>
            <tr class="contact__form--tr">
                <td class="contact__form--left"></td>
            ...
            <tr class="contact__form--tr">
                ...
                <td class="contact__form--right">
                    <input class="contact__form--address" type="address" name="address" value="{{ old('address') }}" placeholder="　　例：東京都渋谷区千駄ヶ谷1-2-3">
                </td>
            </tr>
            <tr class="contact__form--tr">
                <td class="contact__form--left"></td>
            ...
            <tr class="contact__form--tr">
                ...
                <td class="contact__form--right">
                    <input class="contact__form--address" type="address2" name="address2" value="{{ old('address2') }}" placeholder="　　例：千駄ヶ谷マンション101">
                </td>
            </tr>
            ...
            <tr class="contact__form--tr">
                ...
                <td class="contact__form--right contact__form--select">
                    <select class="contact__form--category" name="category_id" value="{{ old('category_id') }}">
            ...
            <tr class="contact__form--tr">
                ...
                <td class="contact__form--right"><textarea class="contact__form--textarea"  name="detail" value="{{ old('detail') }}" id="" cols="" rows="5" placeholder="　お問い合わせ内容をご記載ください"></textarea></td>
            </tr>
            <tr class="contact__form--tr">
                <td class="contact__form--left"></td>
                <td class="contact__form--right">
